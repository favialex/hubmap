# %% [markdown]
# # Experiment 18: 18_negative_images
# 
# "Forked" from 16, not 17!
# 
# Average Test Dice: 
# 
...
# %%
def negate_image(im): return 1 - im
...
def get_noisy_transforms()->monai.transforms.Compose:
    return monai.transforms.Compose([
        ...
        monai.transforms.Lambdad(KEYS, negate_image),
...
def get_load_transforms() -> monai.transforms.Compose:
    return monai.transforms.Compose([
        ...
        monai.transforms.Lambdad((IMAGE,), negate_image),
...
# %%
fn = np.random.choice(COMBINED_DF.id.values)
d = {IMAGE:fn,LABEL:fn}
d = get_test_transforms()(d)
#plot_image_mask(d[IMAGE], d[LABEL])
