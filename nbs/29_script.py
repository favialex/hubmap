# %% [markdown]
# # Experiment 29: 29_testing_losses_lung_spleen
# 
# 'Fork' of 26.
# 
# Average Test Dice: 
...
# %%
EXP_NAME = "29_testing_losses_lung_spleen"
...
losses = {
    "dice": monai.losses.DiceLoss(softmax=True),
    "jaccard": monai.losses.DiceLoss(softmax=True, jaccard=True),
    "bce": monai.losses.FocalLoss(gamma=0),
}
